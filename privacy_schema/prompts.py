...
def _processing_activity_prompt(law: str, ref: str, text: str) -> str:
    ...
    return (
        ...
        "### Decision guide for `action`\n"
        "Text contains...                                              action\n"
        "----------------------------------------------------------------------\n"
        "gather / obtain / receive / ask for / require from subject    Collect\n"
        "keep / retain / hold / maintain / store in records            Store\n"
        "access / use internally / process / analyse / apply           Use\n"
        "share with third party / provide to / give access to          Share\n"
        "send abroad / cross-border / international transfer           Transfer\n"
        "remove / destroy / erase / purge / no longer retain           Delete\n\n"
        "CRITICAL: Do NOT default to Collect unless the article specifically\n"
        "describes gathering new information from individuals.\n\n"
        "### Output schema\n"
        "{\n"
        '  "activityId": "",\n'
...
def _constraint_prompt(law: str, ref: str, text: str) -> str:
    ...
    return (
        ...
        "  inaccurate / rectif\n"
        "make available / policies publicly / openness /            Transparency\n"
        "  inform / notify / disclose policies / be open about\n"
        "security safeguard / protect against / encryption /        Security\n"
        "  unauthorized access / physical / technical measures\n\n"
        "CRITICAL: Security applies ONLY when the text explicitly mentions\n"
        "protecting data from unauthorized access or physical/technical safeguards.\n"
        "Do NOT use Security as a default.\n\n"
        "### Key rules\n"
